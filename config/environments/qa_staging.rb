Rails.application.configure do
  ...
  hostname = 'qa.zippy.it-atlantic.com'
  ...
  config.aws_options = {:storage => :s3, :s3_credentials => {:bucket => 'vk-staging-qa', :s3_host_name => 's3-eu-central-1.amazonaws.com', :url => ':s3_domain_url'}}
